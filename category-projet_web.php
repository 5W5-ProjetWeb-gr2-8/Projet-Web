    ...
    <div class="fond_projet">
      ...
      <div class="contenu_projet">
        ...
        <div class="details_projet">
          ...
          <p class="cours_projet"><b class="programmation_gras">Domaine :</b> 582-5W5-MA Projet web en équipe</p>
      ...
      <div class="description_projet">
        <p>
          ...
          la réalisation de leurs sites <b class="programmation_gras">Web</b> adaptatif de leurs sites Web adaptatifs à l'aide
          de <b class="programmation_gras">WordPress</b>, HTML/CSS, PHP, JavaScript, et React.
        </p>
      </div>
    </div>
  </section>
